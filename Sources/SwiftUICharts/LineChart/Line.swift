...
public struct Line: View {
	...
	public init(
		...
		if let showFull = showFull {
			_showFull = State(initialValue: showFull)
		} else {
			_showFull = State(initialValue: true)
		}
		if let showBackground = showBackground {
			_showBackground = State(initialValue: showBackground)
		} else {
